...
echo "manifest: ${dockername}:12-3.4.3-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:12-3.4.3-bookworm \
    --target ${dockername}:12-3.4.3-bookworm || true
...
echo "manifest: ${dockername}:12-3.4.3-bullseye"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:12-3.4.3-bullseye \
    --target ${dockername}:12-3.4.3-bullseye || true
...
echo "manifest: ${dockername}:13-3.4.3-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:13-3.4.3-bookworm \
    --target ${dockername}:13-3.4.3-bookworm || true
...
echo "manifest: ${dockername}:13-3.4.3-bullseye"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:13-3.4.3-bullseye \
    --target ${dockername}:13-3.4.3-bullseye || true
...
echo "manifest: ${dockername}:14-3.4.3-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:14-3.4.3-bookworm \
    --target ${dockername}:14-3.4.3-bookworm || true
...
echo "manifest: ${dockername}:14-3.4.3-bullseye"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:14-3.4.3-bullseye \
    --target ${dockername}:14-3.4.3-bullseye || true
...
echo "manifest: ${dockername}:15-3.4.3-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:15-3.4.3-bookworm \
    --target ${dockername}:15-3.4.3-bookworm || true
...
echo "manifest: ${dockername}:15-3.4.3-bullseye"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:15-3.4.3-bullseye \
    --target ${dockername}:15-3.4.3-bullseye || true
...
echo "manifest: ${dockername}:15-3.4.3-bundle0-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:15-3.4.3-bundle0-bookworm \
    --target ${dockername}:15-3.4.3-bundle0-bookworm || true
...
echo "manifest: ${dockername}:15-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:15-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm \
    --target ${dockername}:15-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm || true

echo "manifest: ${dockername}:15-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:15-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm \
    --target ${dockername}:15-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm || true
...
echo "manifest: ${dockername}:16-3.4.3-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-3.4.3-bookworm \
    --target ${dockername}:16-3.4.3-bookworm || true
...
echo "manifest: ${dockername}:16-3.4.3-bullseye"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-3.4.3-bullseye \
    --target ${dockername}:16-3.4.3-bullseye || true
...
echo "manifest: ${dockername}:16-3.4.3-bundle0-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-3.4.3-bundle0-bookworm \
    --target ${dockername}:16-3.4.3-bundle0-bookworm || true
...
echo "manifest: ${dockername}:16-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm \
    --target ${dockername}:16-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm || true

echo "manifest: ${dockername}:16-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm \
    --target ${dockername}:16-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm || true
...
echo "manifest: ${dockername}:17-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:17-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm \
    --target ${dockername}:17-recent-postgis3.5.0-geos3.13.0-proj9.5.0-gdal3.9.2-cgal6.0-sfcgal1.5.2-bookworm || true

echo "manifest: ${dockername}:17-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:17-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm \
    --target ${dockername}:17-recent-postgis3.5-geos3.13-proj9.5-gdal3.9-cgal6.0-sfcgal1.5-bookworm || true
