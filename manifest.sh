...
echo "manifest: ${dockername}:16-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:16-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm \
    --target ${dockername}:16-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm || true
...
echo "manifest: ${dockername}:17-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm"
manifest-tool push from-args \
    --platforms linux/amd64,linux/arm64 \
    --template ${dockername}-ARCHVARIANT:17-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm \
    --target ${dockername}:17-recent-postgis3.5.1-geos3.13.0-proj9.5.1-gdal3.10.1-cgal6.0.1-sfcgal2.0.0-bookworm || true
